	...
	return (
		<main className="workspace-shell">
			...
			<section className="workspace-intro" id="overview">
				<div>
					<p className="eyebrow">Friday, 21 August 2026</p>
					<h1>Good work starts with clear criteria.</h1>
					<p className="intro-copy">
						Create a job, confirm what matters, and review the
						evidence behind every evaluation.
					</p>
				</div>
				<div className="usage-meter">
					<div>
						...
						<strong>
							240 <small>available</small>
						</strong>
					</div>
					<div className="meter">
						<span />
					</div>
					<p>60 points used this month</p>
				</div>
			</section>
			<section className="metric-strip" aria-label="Workspace summary">
				...
				<div>
					...
					<strong>
						...
						<em>{evaluations.length ? "/100" : ""}</em>
					</strong>
					<small>best documented fit</small>
				</div>
				<div>
			...
			<section className="workspace-grid">
				...
				<div className="workspace-column">
					<div className="section-heading">
						<div>
							<p className="section-kicker">Build a role</p>
							<h2>Create a job</h2>
						</div>
					</div>
					...
					<div className="section-heading jobs-heading">
						<div>
							<p className="section-kicker">Recent roles</p>
							<h2>Jobs</h2>
						</div>
				...
				<div
					className="workspace-column workspace-column-detail"
					id="activity"
				>
					<div className="section-heading">
						<div>
